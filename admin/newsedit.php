...
<body >
    ...
    <!-- 触发editvip-->
 	<div class="page-header text-center">
        <h1>新闻编辑<small>后台管理</small></h1>
    </div>
    <form class="form-horizontal" method="post" action="newsedit.handle.php">
        <input type="hidden" name="id" value="<?php echo $row3['id'];?>">
        <div class="form-group">
            <label for="title" class="control-label col-md-2">标题</label>
            <div class="col-md-2">
            <input type="text" class="form-control" id="title" name="title" placeholder="<?php echo $row3['title'];?>">
            </div>
        </div>
        <div class="form-group">
            <label for="source" class="control-label col-md-2">来源</label>
            <div class="col-md-2">
            <input type="text" class="form-control" id="source" name="source" placeholder="<?php echo $row3['source'];?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label"><button class="btn btn-primary" type="submit">修改</button></label>
