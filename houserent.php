<?php 
    ...
    $id = $_GET['id'];
    $rent = getonehouse($id, "house_rent");
    $vid = $_SESSION['vipid'];
...
<body>
	...
	<div class="container">
	   <div class="page-header " >
	      <div class="row">
            <div class="col-md-8 text-center"><h2><strong><?php echo $rent['title'];?></strong></h2></div>
            <div class="col-md-4 text-right">
                <h3>
                    <small>
                        发布时间:<?php echo date('Y-m-d H:i:s',$rent['pubtime'])."&nbsp"."&nbsp";
                                    if($_SESSION['adminid']) 
                                        echo "<a class='btn btn-info btn-xs' href='admin/houserentedit.php?id={$rent['id']}'>编辑</a> &nbsp; | &nbsp; <a class='btn btn-danger btn-xs' href='admin/houserentdel.handle.php?id={$rent['id']}'>删除</a>";
                                    else if($vid == $rent['vid'])
                                        echo "<a class='btn btn-info btn-xs' href='vip/houserentedit.php?id={$rent['id']}'>编辑</a> &nbsp; | &nbsp; <a class='btn btn-danger btn-xs' href='vip/houserentdel.handle.php?id={$rent['id']}'>删除</a>";
                                 ?>
                    </small>
                </h3>
            </div>
...
eof;
        ...
        <div class="col-md-7">
            <ul class="list-unstyled" style="color:#666;font-size:16px;line-height:26px">
               <li >
                <p>租金&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<span style="font-size:30px;color:#f60;"><?php echo $rent['rent'];?>元/月</span></p>
               </li> 
               <li>
                <p>所在小区&nbsp; &nbsp; &nbsp;<?php echo $rent['community'];?> </p>
               </li>
               <li>
                <p>户型&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<?php echo $rent['room']."室".$rent['hall']."厅".$rent['toilet']."卫";?> </p>
               </li>
               <li>
                <p>面积&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<?php echo $rent['area'];?>平米</p>
               </li>
               <li>
                <p>装修程度&nbsp; &nbsp; &nbsp;<?php echo $rent['decoration'];?> </p>
               </li>
               <li>
                <p>地址&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<?php echo $rent['province'].$rent['city'].$rent['county'].$rent['town'].$rent['address'];?> </p>
               </li>
               <li>
                <p>出租时间&nbsp; &nbsp; &nbsp;<?php echo $rent['time'];?> </p>
               </li>
               <li>
                <p>联系姓名&nbsp; &nbsp; &nbsp;<?php echo $rent['name'];?> </p>
               </li>
               <li>
                <p>联系手机&nbsp; &nbsp; &nbsp;<?php echo $rent['phone'];?> </p>
               </li>
            </ul>
        </div>
       </div>
       <hr/>
       <h1 class="lead" style="margin-top: 50px"><strong><?php echo $rent['content'];?></strong></h1>
