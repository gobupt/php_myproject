                ...
                <h3>
                    <small>
                        发布时间:<?php echo date('Y-m-d H:i:s',$sale['pubtime'])."&nbsp"."&nbsp";
                                    if($_SESSION['adminid']) 
                                        echo "<a class='btn btn-info btn-xs' href='admin/houseneededit.php?id={$sale['id']}'>编辑</a> &nbsp; | &nbsp; <a class='btn btn-danger btn-xs' href='admin/houseneeddel.handle.php?id={$need['id']}'>删除</a>";
                                    else if($vid == $sale['vid'])
                                        echo "<a class='btn btn-info btn-xs' href='vip/houseneededit.php?id={$sale['id']}'>编辑</a> &nbsp; | &nbsp; <a class='btn btn-danger btn-xs' href='vip/houseneeddel.handle.php?id={$need['id']}'>删除</a>";
                                 ?>
                    </small>
                </h3>
            </div>
...
eof;
       ...
       <hr/>
       <p class="lead" style="margin-top: 50px"><?php echo $sale['content'];?></p>
