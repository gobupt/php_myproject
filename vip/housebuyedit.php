	...
	<div class="container-fluid" style="margin-bottom: 30px">
		<div class="row">
			...
			<div class="col-md-11">
				...
				<form class="form-horizontal"  action="edithousebuy.handle.php" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-1">
							<input type="text" class="form-control" name="province"
								id="province" placeholder="省(选填)" value="<?php echo $buy['province'];?>">
						</div>
						<div class="col-md-1">
						...
						<div class="col-md-2">
							<input type="text" class="form-control" name="address"
								id="address" placeholder="详细地址" value="<?php echo $buy['address'];?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-2">
							<select class="form-control" name="price">
								<option value="1" <?php if($buy['price']==1) echo 'selected="selected"';?>>50以下</option>
								<option value="2" <?php if($buy['price']==2) echo 'selected="selected"';?>>50-80</option>
								<option value="3" <?php if($buy['price']==3) echo 'selected="selected"';?>>80-100</option>
								<option value="4" <?php if($buy['price']==4) echo 'selected="selected"';?>>100-120</option>
								<option value="5" <?php if($buy['price']==5) echo 'selected="selected"';?>>120-150</option>
								<option value="6" <?php if($buy['price']==6) echo 'selected="selected"';?>>150-200</option>
								<option value="7" <?php if($buy['price']==7) echo 'selected="selected"';?>>200以上</option>
							</select>
						</div>
						<div class="col-md-4">
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							<select class="form-control" name="area">
								<option value="1" <?php if($buy['area']==1) echo 'selected="selected"';?>>50以下</option>
								<option value="2" <?php if($buy['area']==2) echo 'selected="selected"';?>>50-70</option>
								<option value="3" <?php if($buy['area']==3) echo 'selected="selected"';?>>70-90</option>
								<option value="4" <?php if($buy['area']==4) echo 'selected="selected"';?>>90-120</option>
								<option value="5" <?php if($buy['area']==5) echo 'selected="selected"';?>>120-150</option>
								<option value="6" <?php if($buy['area']==6) echo 'selected="selected"';?>>150-200</option>
								<option value="7" <?php if($buy['area']==7) echo 'selected="selected"';?>>200-500</option>
								<option value="8" <?php if($buy['area']==8) echo 'selected="selected"';?>>500以上</option>
							</select>
						</div>
						<div class="col-md-4">
