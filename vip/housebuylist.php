<?php 
    ...
    $row = getonevip($id);
    $pagesize=5;
    $totalrows=gethousenum("house_buy","vid=$id");   
    $page=$_GET['page']?$_GET['page']:1;
    $totalpage=ceil($totalrows/$pagesize);
    $row3 = gethousebypage($pagesize, $page, $totalpage,"house_buy","vid=$id"); 
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
						...
						<table class="table table-bordered table-hover table-striped ">
                            ...
                            <tr>
								...
								<td class="text-center"><a class="btn btn-info btn-xs"
									href="housebuyedit.php?id=<?php echo $v['id'];?>">编辑</a> &nbsp;
									&nbsp; <a class="btn btn-danger btn-xs"
									href="housebuydel.handle.php?id=<?php echo $v['id'];?>">删除</a></td>
							</tr>
							<?php $k++;}
							    }?>
                        </table>
